                    ...
                    <table>
                        ...
                        <?php
                         ...
                         while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='editLecture.php?id=" . $row['Id'] . "'><i class='ri-edit-line edit'></i></a>
                                    <a href='deleteLecture.php?id=" . $row['Id'] . "' onclick=\"return confirm('Are you sure you want to delete this record?');\"><i class='ri-delete-bin-line delete'></i></a>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
                ...
                <div class="table">
                    <table>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='editStudent.php?id=" . $row['Id'] . "'><i class='ri-edit-line edit'></i></a>
                                    <a href='deleteStudent.php?id=" . $row['Id'] . "' onclick=\"return confirm('Are you sure you want to delete this record?');\"><i class='ri-delete-bin-line delete'></i></a>
                                </td>";
                            echo "</tr>";
                        }
                    } else {
                ...
                <div class="table">
                    <table>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='editVenue.php?id=" . $row['ID'] . "'><i class='ri-edit-line edit'></i></a>
                                    <a href='deleteVenue.php?id=" . $row['ID'] . "' onclick=\"return confirm('Are you sure you want to delete this record?');\"><i class='ri-delete-bin-line delete'></i></a>
                                </td>";
                            echo "</tr>";
                        }
                    } else {
                ...
                <div class="table">
                    <table>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='editCourse.php?id=" . $row['course_id'] . "'><i class='ri-edit-line edit'></i></a>
                                    <a href='deleteCourse.php?id=" . $row['course_id'] . "' onclick=\"return confirm('Are you sure you want to delete this record?');\"><i class='ri-delete-bin-line delete'></i></a>
